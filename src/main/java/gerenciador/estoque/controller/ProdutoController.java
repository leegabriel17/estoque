...
public class ProdutoController {
    ...
    public ResponseEntity<ProdutoResponse> salvar(@RequestBody @Valid ProdutoRequest produtoRequest, UriComponentsBuilder uriBuilder) {
        ...
        ProdutoResponse produtoSalvo = produtoServiceInterface.salvar(produtoRequest);
    ...
    public ResponseEntity<ProdutoResponse> atualizar(@PathVariable Long id, @RequestBody @Valid ProdutoRequest produtoRequest) {
        ...
        ProdutoResponse produtoAtualizado = produtoServiceInterface.atualizar(id, produtoRequest);
    ...
    public ResponseEntity<Void> deletar(@PathVariable Long id) {
        ...
        produtoServiceInterface.deletar(id);
    ...
    public ResponseEntity<List<ProdutoResponse>> listarTodos() {
        ...
        return ResponseEntity.ok(produtoServiceInterface.listarTodos());
    }
    ...
    public ResponseEntity<ProdutoResponse> buscarPorId(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(produtoServiceInterface.buscarPorId(id));
    }
}